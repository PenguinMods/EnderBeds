...
> 
> The preferred way to do this is to [create a Pull Request](https://github.com/PenguinMods/EnderBeds/compare) or to [start a discussion](https://github.com/PenguinMods/EnderBeds/discussions/new/choose) on the GitHub repository. Alternatively, get in touch at [mods+ender_beds@blockypenguin.com](mailto:mods+ender_beds@blockypenguin.com).\
> Thanks! :D
...
2. `ender_beds:endermite_spawn_chance`\
